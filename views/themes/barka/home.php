...
<main class="container space-y-5 my-5 flex-1">
  ...
  <div class="flex flex-col lg:flex-row items-start gap-x-6 relative space-y-5 lg:space-y-0">
    <div class="w-full lg:w-2/3 space-y-4">
      <h3 class="font-heading text-2xl capitalize font-black text-title"><span class="fa fa-newspaper-o"></span> Artikel Terbaru</h3>
      ...
      <?php if ($albums->num_rows() > 0) : ?>
        <h3 class="font-heading text-2xl capitalize font-black text-title py-2"><i class="fa fa-camera"></i> Album Foto</h3>
